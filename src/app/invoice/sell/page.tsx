...
import { AiOutlineDelete, AiOutlineEdit, AiOutlineInfo, AiOutlineInfoCircle, AiOutlinePlus } from "react-icons/ai";
import { useMemo, useState } from "react";
import 'react-confirm-alert/src/react-confirm-alert.css'
import Applayout from "@/components/layout/Applayout";
import SellInvoiceContainer from "@/container/invoice/sell/SellInvoiceContainer";
import { FaRegFilePdf } from "react-icons/fa";
import { PDFDownloadLink, PDFViewer } from "@react-pdf/renderer";
import SellInvoicePdf from "@/pdf/SellInvoice";
...
export default function InvoicePage() {
    ...
    const container = SellInvoiceContainer();
                                ...
                                <tr key={key}>
                                    ...
                                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <div className="flex items-center felx-row space-x-3.5">
                                            ...
                                            <button className="hover:text-primary">
                                                {/* <PDFDownloadLink document={<SellInvoicePdf invoice={invoice} />} fileName="somename.pdf">
                ...
                <div className="flex gap-3">
                    ...
                    <div className={`${selectedCustomer == undefined ? 'hidden' : 'block'} flex-2 flex flex-col bg-white dark:bg-boxdark border-stroke dark:border-strokedark rounded-sm border gap-5 px-5 pt-6 pb-2.5 sm:px-7.5 xl:pb-1 `}>
                        ...
                        <div className="flex flex-row justify-between items-center w-full">
                            ...
                            <div className=" text-danger cursor-pointer text-6xl">
                                <IoIosClose clasName="w-8 h-8 " onClick={() => { setSelectedCustomer(undefined) }} />
                            </div>
                        </div>
                        {/* header */}
