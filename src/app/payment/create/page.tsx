...
import { sales, showCheckboxesModeLabel, selectAllModeLabel } from './data';
        ...
        <Applayout>
            <div className="flex flex-col gap-5 h-full ">
                ...
                >
                    ...
                    <Column dataField={myTools.propToString<SellInvoice>().invoiceNumber + ""} caption="Invoice Number" width={90} />
                    <Column dataField={myTools.propToString<SellInvoice>().invoiceDate + ""} caption="Invoice Date" width={90} />
                    <Column dataField={myTools.propToString<SellInvoice>().total + ""} caption="Invoice Total" width={90} />
